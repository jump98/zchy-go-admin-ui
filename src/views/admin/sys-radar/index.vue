        ...
        <template #wrapper>
            <el-card class="box-card">
                ...
                <el-row :gutter="10" class="mb8">
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['admin:sysRadar:add']"
                                type="primary"
                                icon="el-icon-plus"
                                size="mini"
                                @click="handleAdd"
                    ...
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['admin:sysRadar:edit']"
                                type="success"
                                icon="el-icon-edit"
                                size="mini"
                                :disabled="single"
                    ...
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['admin:sysRadar:remove']"
                                type="danger"
                                icon="el-icon-delete"
                                size="mini"
                                :disabled="multiple"
                        ...
                        <el-table 
                            ...
                            <el-table-column label="状态" width="80" sortable="custom">
                                ...
                                <el-switch
                                    ...
                                    :disabled="!checkThisPermission(['admin:sysRadar:edit'])"
                                />
                                </template>
                            </el-table-column>
                            <el-table-column
                ...
                <el-row style="margin-top: 20px;">
                    <el-col>
                        <div class="radar-components-row" v-show="curradarid!==undefined">
                        ...
                        <div class="radar-components-row">
                            <div class="radar-component">
                                <RadarStateInfo v-show="curradarid!==undefined" :radarid="curradarid"></RadarStateInfo>
                            </div>
                            <div class="radar-component">
                                <RadarDeviceInfo v-show="curradarid!==undefined" :radarid="curradarid"></RadarDeviceInfo>
                            </div>
                        </div>
                        <RadarPoint v-show="curradarid!==undefined"  ref="refRadarPoint" :radarid="curradarid"></RadarPoint>
                    </el-col>
                </el-row>
            </el-card>
        </template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                // 表单校验
                rules: {radarId:  [ {required: true, message: 'RadarID不能为空', trigger: 'blur'} ],
