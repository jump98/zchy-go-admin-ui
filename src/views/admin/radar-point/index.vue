...
<template>
    <BasicLayout>
        <template #wrapper>
            <RadarImage
                v-if="checkThisPermission(['admin:radarPoint:edit'])"
                :radarid="radarid"
                @sigAddRadarPoint="onAddRadarPoint"
            />
            ...
            <el-card class="box-card">
                ...
                <el-table v-loading="loading" :data="radarPointList" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="名称" align="center" prop="pointName"
                        :show-overflow-tooltip="true"/>
                    <el-table-column label="编号" align="center" prop="pointKey"
                        :show-overflow-tooltip="true"/>
                    <el-table-column label="下标" align="center" prop="pointIndex"
                        :show-overflow-tooltip="true"/>
                    ...
                    <el-table-column label="经度" align="center" prop="lng"
                                        :show-overflow-tooltip="true"/><el-table-column label="纬度" align="center" prop="lat"
                                        :show-overflow-tooltip="true"/><el-table-column label="高度" align="center" prop="alt"
                                        :show-overflow-tooltip="true"/><el-table-column label="距离" align="center" prop="distance"
                                        :show-overflow-tooltip="true"/><el-table-column label="备注" align="center" prop="remark"
                                        :show-overflow-tooltip="true"/><el-table-column label="激活状态" align="center" prop="aStatus"
                                        :formatter="aStatusFormat" width="100">
                        <template slot-scope="scope">
                            {{ aStatusFormat(scope.row) }}
                        </template>
                    </el-table-column><el-table-column label="消警状态" align="center" prop="xStatus"
                                        :formatter="xStatusFormat" width="100">
                        <template slot-scope="scope">
                            {{ xStatusFormat(scope.row) }}
                        </template>
                    </el-table-column><el-table-column label="门限类型" align="center" prop="mTypeId"
                                        :formatter="mTypeIdFormat" width="100">
                        <template slot-scope="scope">
                    ...
                    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                        <el-row>
                            ...
                            <el-form-item label="雷达"
                                prop="radarId"
                                >
                                <el-select v-model="radarid"
                                            placeholder="请选择" disabled >
                                        <el-option
                                                v-for="dict in radarIdOptions"
                                                :key="dict.key"
                                                :label="dict.value"
                                                :value="dict.key"
                                        />
                        ...
                        <el-row>
                            ...
                            <el-form-item label="激活状态" prop="aStatus">
                                <el-select v-model="form.aStatus"
                                                placeholder="请选择" >
                                        <el-option
                                                v-for="dict in aStatusOptions"
                                                :key="dict.value"
                            ...
                            <el-form-item label="消警状态" prop="xStatus">
                                <el-select v-model="form.xStatus"
                                                placeholder="请选择" >
                                        <el-option
                                                v-for="dict in xStatusOptions"
                                                :key="dict.value"
                                                :label="dict.label"
                                                :value="dict.value"
                                        />
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="门限类型" prop="mTypeId">
                                    <el-select v-model="form.mTypeId"
                                                    placeholder="请选择" >
                                            <el-option
                                                    v-for="dict in mTypeIdOptions"
                                                    :key="dict.value"
                                                    :label="dict.label"
                                                    :value="dict.value"
                                            />
                            ...
                            <el-col :span="12">
                                <el-form-item label="下标" prop="pointIndex">
                                    <el-input-number
                                    v-model.number="form.pointIndex" placeholder="请输入0-1999之间的数字"
                                    :controls="false"
                                    class="lnglatnumber"/>
                                </el-form-item>
                            </el-col>
    ...
    export default {
        ...
        data() {
            return {
                ...
                typeOptions: [],
                radarPointList: [],
                pointTypeOptions: [],aStatusOptions: [],xStatusOptions: [],mTypeIdOptions: [],
                // 关系表类型
                radarIdOptions :[],
                ...
                // 表单校验
                rules: {id:  [ {required: true, message: 'PointID不能为空', trigger: 'blur'} ],
